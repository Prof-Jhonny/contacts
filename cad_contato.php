    ...
    <div class="container m-5 text-center">
        <form action="cad_contato.act.php" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" placeholder="Nascimento" aria-label="Cellphone" aria-describedby="basic-addon1" name="nascimento" id="dtNascimento">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text">Observações/Apelidos</span>
                <textarea class="form-control" aria-label="With textarea" name="apelidos"></textarea>
            </div>
