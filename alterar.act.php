...
if (mysqli_query($con, "UPDATE `tb_contatos` SET `nome` = '$nome', `sexo` = '$sexo', `telefone` = '$telefone', `email` = '$email',`nascimento` = '$nascimento', `foto` = '$foto_anterior', `apelidos` = '$apelidos' WHERE `tb_contatos`.`codigo` = '$codigo';")) {
