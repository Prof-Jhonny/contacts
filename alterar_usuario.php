...
<body>
    ...
    require('connect.php');
    $codigo = $_GET['codigo'];
    $contato = mysqli_query($con, "Select * from `tb_usuarios` where `codigo` = '$codigo'");
    $contato = mysqli_fetch_array($contato);
    $email = explode('@', $contato['email']);
    ?>

    <div class="container m-5 text-center">
        <form action="alterar_usuario.act.php" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-column bd-highlight mb-3 btn-info">Alterar Usuário</div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" value="<?php echo $contato['nascimento']; ?>" placeholder="Data de Nascimento" aria-label="Cellphone" aria-describedby="basic-addon1" name="nascimento" id="dtNascimento">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <div class="container-img-incluir">
                    <img src="<?php echo $contato['foto']; ?>" alt="" id="previewImg">
                </div>
